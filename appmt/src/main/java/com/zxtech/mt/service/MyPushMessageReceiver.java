...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context mContext, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            param.put("user_id", SPUtils.get(mContext,"user_id","").toString());
            param.put("channel_id", channelId);
            HttpUtil.getInstance(mContext).request("/mtmo/bindchannel.mo", param, new HttpCallBack<String>() {
                @Override
...
//        List<String> line_tag = PushUtil.getTagsList(UIController.EMP_INFO.getId());
//        PushManager.setTags(context.getApplicationContext(), line_tag);
...
//        updateContent(context, responseString);
    ...
    private void updateContent(final Context mContext, String content) {
