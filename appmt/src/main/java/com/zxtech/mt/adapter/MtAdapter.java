 ...
 */
public class MtAdapter extends CommonAdapter<MtWorkPlan>{


    public MtAdapter(Context context, List<MtWorkPlan> datas, int layoutId) {
    ...
    public void convert(ViewHolder holder, final MtWorkPlan mtWorkPlan, final int position) {
        ...
        if (Constants.MT_WORK_STATUS_FINISH.equals(mtWorkPlan.getStatus())){
            ...
            ImageView right_arrow_imageview = holder.getView(R.id.right_arrow_imageview);
