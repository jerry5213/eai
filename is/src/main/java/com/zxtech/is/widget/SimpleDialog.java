...
public class SimpleDialog {
    ...
    public static AlertDialog createDialog(Context context, CharSequence title, CharSequence msg) {
        return createDialog(context, title, msg, context.getString(R.string.is_confirm), (CharSequence)null, (OnClickListener)null, (OnClickListener)null, true);
    }
    ...
    public static AlertDialog createDialog(Context context, CharSequence title, CharSequence msg, OnClickListener posListener, boolean canceledOnTouchOutside) {
        return createDialog(context, title, msg, context.getString(R.string.is_confirm), context.getString(R.string.cancel), posListener, (OnClickListener)null, canceledOnTouchOutside);
    }
}
