...
public class TaskMeTransportAdapter extends BaseQuickAdapter<Map<String, Object>, BaseViewHolder> {
    public TaskMeTransportAdapter(int layoutResId, @Nullable List<Map<String, Object>> data) {
