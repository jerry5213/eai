...
public class TaskMeTemporaryTaskProblemAqjcFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.OnItemClickListener {
    ...
    public static TaskMeTemporaryTaskProblemAqjcFragment newInstance() {
        return new TaskMeTemporaryTaskProblemAqjcFragment();
    }
...
//        userId = "08034624-5A68-4A2A-B7D2-F03360B1115C";
        ...
        temporaryTaskService.selectQuestionInfoByUserId(userId, "01", pageNum, pageSize)
