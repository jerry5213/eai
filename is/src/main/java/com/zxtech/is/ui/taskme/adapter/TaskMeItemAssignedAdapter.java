...
public class TaskMeItemAssignedAdapter extends BaseQuickAdapter<Map<String, Object>, BaseViewHolder> {
    public TaskMeItemAssignedAdapter(int layoutResId, @Nullable List<Map<String, Object>> data) {
