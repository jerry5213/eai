...
public class TaskMeInstaWayRecordsAdapter extends BaseQuickAdapter<Map<String, Object>, BaseViewHolder> {
    public TaskMeInstaWayRecordsAdapter(int layoutResId, @Nullable List<Map<String, Object>> data) {
