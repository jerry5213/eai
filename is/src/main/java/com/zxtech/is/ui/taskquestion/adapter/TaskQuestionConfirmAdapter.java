...
public class TaskQuestionConfirmAdapter extends BaseQuickAdapter<TaskQuestionPic, BaseViewHolder> {

    public TaskQuestionConfirmAdapter(int layoutResId, @Nullable List<TaskQuestionPic> data) {
