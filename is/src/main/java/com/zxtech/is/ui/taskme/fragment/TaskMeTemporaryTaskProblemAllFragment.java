...
public class TaskMeTemporaryTaskProblemAllFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.OnItemClickListener {
    ...
    public static TaskMeTemporaryTaskProblemAllFragment newInstance() {
        return new TaskMeTemporaryTaskProblemAllFragment();
    }
...
//        userId = "08034624-5A68-4A2A-B7D2-F03360B1115C";
        ...
        temporaryTaskService.selectQuestionInfoByUserId(userId, "", pageNum, pageSize)
