...
public class TransportS2Fragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public static TransportS2Fragment newInstance() {
        return new TransportS2Fragment();
    }
    ...
    private void requestNet() {
        ...
        engineerService.getEngineersS2List(pageNum, pageSize).compose(RxHelper.<PageResponse<List<Map<String, Object>>>>rxSchedulerHelper())
