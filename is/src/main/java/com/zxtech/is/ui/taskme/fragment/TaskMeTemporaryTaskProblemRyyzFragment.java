...
public class TaskMeTemporaryTaskProblemRyyzFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.OnItemClickListener {
    ...
    public static TaskMeTemporaryTaskProblemRyyzFragment newInstance() {
        return new TaskMeTemporaryTaskProblemRyyzFragment();
    }
...
//        userId = "08034624-5A68-4A2A-B7D2-F03360B1115C";
        ...
        temporaryTaskService.selectQuestionInfoByUserId(userId, "03", pageNum, pageSize)
