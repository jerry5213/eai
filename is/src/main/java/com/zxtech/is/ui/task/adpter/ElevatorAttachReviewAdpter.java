...
public class ElevatorAttachReviewAdpter extends BaseQuickAdapter<Attach, BaseViewHolder> {

    public ElevatorAttachReviewAdpter(int layoutResId, @Nullable List<Attach> data) {
