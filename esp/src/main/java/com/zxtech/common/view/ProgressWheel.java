package com.zxtech.common.view;
...
/**
 * 自定义 圆形滚动条控件
 * layout_width 宽度  layout_height高度 text 圆中文字 textColor 圆中文字字体颜色 textSize圆中文字字体大小
 * rimColor 框的填充色 barColor 滚动的颜色 barWidth 滚动条的宽度 rimWidth框的宽度 spinSpeed 滚动的速度
 * @author Chw
 *
 *
 *
...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_circleBarLength,
                barLength);
