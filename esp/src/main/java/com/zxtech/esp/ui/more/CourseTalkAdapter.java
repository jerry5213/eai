...
public class CourseTalkAdapter extends GBaseAdapter<CourseCommentVO.Data> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.tv_owner = (TextView) convertView.findViewById(R.id.tv_owner);
            viewHolder.tv_date = (TextView) convertView.findViewById(R.id.tv_date);
            viewHolder.tv_content = (TextView) convertView.findViewById(R.id.tv_content);
            viewHolder.tv_comment = (TextView) convertView.findViewById(R.id.tv_comment);
            viewHolder.owner_photo = (ImageView) convertView.findViewById(R.id.owner_photo);
    ...
    static class ViewHolder  implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (i == R.id.tv_comment) {
                CourseCommentVO.Data data = (CourseCommentVO.Data) v.getTag();
                ((CourseDetailActivity) getActivityFromView(v)).initPopupWindow(data);

            } else {
            }
        }

        public void showData(CourseCommentVO.Data data){
