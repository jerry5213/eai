...
//                holder.setText(R.id.title, lv0.name);
            ...
            case TYPE_LEVEL_1:
                ...
                holder.setText(R.id.title1, paramsBeans.get(0).getText(language)).addOnClickListener(R.id.title1);
                holder.setText(R.id.title2, paramsBeans.get(1).getText(language)).addOnClickListener(R.id.title2);
                if (paramsBeans.size() > 2) {
                    holder.setVisible(R.id.title3, true);
                    holder.setText(R.id.title3, paramsBeans.get(2).getText(language)).addOnClickListener(R.id.title3);
                } else {
