package com.zxtech.ecs.widget.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
	...
	private void obtainAttributes(Context context, AttributeSet attrs) {
		...
		mBgSelectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_bgSelectColor, Color.parseColor("#ffffff"));
		mTextUnselectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
		mUnBgSelectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_bgUnSelectColor, Color.parseColor("#AAffffff"));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
			...
			RelativeLayout rl_tab = v.findViewById(R.id.rl_tab);
			if (tv_tab_title != null) {
				tv_tab_title.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
				rl_tab.setBackgroundColor(i == mCurrentTab ? mUnBgSelectColor : mBgSelectColor);
	...
	private void updateTabSelection(int position) {
		for (int i = 0; i < mTabCount; ++i) {
			...
			RelativeLayout rl_tab = tabView.findViewById(R.id.rl_tab);
			MsgView tipView = tabView.findViewById(R.id.rtv_msg_tip);

			if (tab_title != null) {
				tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
				rl_tab.setBackgroundColor(isSelect ? mUnBgSelectColor : mBgSelectColor);
				tipView.setTextColor(isSelect ? Color.WHITE : Color.BLACK);
	...
	private void calcIndicatorRect() {
		...
		if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
			...
			RelativeLayout rl_tab = currentTabView.findViewById(R.id.rl_tab);
			mTextPaint.setTextSize(mTextsize);
//			rl_tab.setBackgroundColor(Color.WHITE);
	...
	public void showMsg(int position, int num) {
		...
		if (tipView != null) {
			...
			tipView.setTextColor(mCurrentTab == position ? Color.WHITE : Color.BLACK);
			if (mInitSetMap.get(position) != null && mInitSetMap.get(position)) {
				return;
			}

			setMsgMargin(position, 20, 30,0);
	 ...
	 */
	public void setMsgMargin(int position, float leftPadding, float rightPadding,float bottomPadding) {
		if (position >= mTabCount) {
			position = mTabCount - 1;
		}
		View tabView = mTabsContainer.getChildAt(position);
		...
		if (tipView != null) {
			...
			lp.rightMargin = (int)rightPadding;
