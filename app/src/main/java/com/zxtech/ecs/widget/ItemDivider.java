...
public class ItemDivider extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            int top1 = child.getTop() - offSet - params.topMargin + 20;
            int bottom1 = child.getBottom() + offSet + params.bottomMargin -20;
            //绘制分割线(矩形)
            c.drawRect(left1, top1, right1, bottom1, paint);
            int left2 = child.getLeft() - offSet - params.leftMargin +20;
            int right2 = child.getRight() + offSet + params.rightMargin -20;
