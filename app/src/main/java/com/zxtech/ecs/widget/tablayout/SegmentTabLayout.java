...
//		mUnBgSelectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_bgUnSelectColor, Color.parseColor("#2C97DE"));
...
//			rl_tab.setBackgroundColor(isSelect ? mUnBgSelectColor : mBgSelectColor);
			...
			tipView.setTextColor(isSelect ? Color.WHITE : Color.parseColor("#0075c2"));
	...
	public void showMsg(int position, int num) {
		...
		if (tipView != null) {
			...
			tipView.setTextColor(mCurrentTab == position ? Color.WHITE : Color.parseColor("#0075c2"));
