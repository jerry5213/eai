package com.zxtech.ecs.ui.home.scheme.bdtts;
...
public class UiMessageListener implements SpeechSynthesizerListener,MainHandlerConstant {
    ...
    public void onSpeechFinish(String s) {
        sendMessage(s, false,SPEECHFINISH);
    }
    ...
    protected void sendMessage(String message) {
        sendMessage(message, false,PRINT);
    }
