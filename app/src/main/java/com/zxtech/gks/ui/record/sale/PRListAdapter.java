...
public class PRListAdapter extends CommonAdapter<RecordApproval> {
    ...
    public PRListAdapter(Context context, List<RecordApproval> datas, int layoutId) {
        super(context,layoutId,datas);
    }

    @Override
    public void convert(ViewHolder holder, RecordApproval recordApproval, final int position) {
